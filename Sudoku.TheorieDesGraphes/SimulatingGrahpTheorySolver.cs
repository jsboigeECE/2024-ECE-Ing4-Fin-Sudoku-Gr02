...
using Sudoku.Shared;
using Sudoku.SimulatingGraphTheory;

namespace Sudoku.TheorieDesGraphes;

public class SimulatingGraphTheorySolver : PythonSolverBase

	{
		public override Shared.SudokuGrid Solve(Shared.SudokuGrid s)
		{
			...
			using (PyModule scope = Py.CreateScope())
			{
				...
				string code = Resources.SimulatingGraphTheory_py;
				scope.Exec(code);
